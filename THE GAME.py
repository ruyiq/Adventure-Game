...
print_pause(
    "Rumor has it that a wicked fairie is somewhere around here, and has been "
...
# park
if ans == '1':
    print_pause("The clerk says that the ticket is $50 but if you would like "
                "to post sth related to the park on instagram then you can "
                "get it for $10. ")
    ...
    if answer == '1':
        ...
        if answer == '1':
            ...
            your_ans = valid_input("Enter 1 if you think it is odd. Enter 2 "
                                   "otherwise.")
...
if ans == '2':
    print_pause("They don't really want one and they offered a price of $2. "
                "DO YOU WANT TO SELL IT OR YOU WANT TO BRING IT BACK TO HOME?")
    ans = valid_input('enter 1 to sell. 2 otherwise.')

    if ans == '1':
        print_pause("Congratulations! You've earned 2 dollars today. However, "
                    "is too late and you are refused from going into the park. "
